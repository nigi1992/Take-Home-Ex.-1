...
```{r}
study1 <- 
  read.csv("/Users/nicolaswaser/New-project-GitHub-first/R/Take-Home-Ex.-1/
    Input Data/study1_data.csv") # Please insert your own data path to run
library(tidyverse)
library(ggplot2)
...
balance_table <- CreateTableOne(vars = covariates, strata = treatment_var, 
                                data = study1_cleaned_transformed, test = TRUE)
...
Repeat the analysis with three iteratively smaller random samples of the
treatment (n = 200, n = 100, n = 10) and control groups (n = 200, n =
...
library(stargazer)
stargazer(OLS_model, model_400, model_200, model_20, type = "text", 
